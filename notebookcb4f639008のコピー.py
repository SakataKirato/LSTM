 ...
 "cells": [
  {
   ...
   "outputs": [],
   "source": [
    "#このコードはclaude sonnet 4.5と協力して作成しました。\n",
    "#参考文献\n",
    "#https://www.kaggle.com/competitions/LANL-Earthquake-Prediction/writeups/character-ranking-3rd-place-memo"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "earthquake_ids = np.concatenate(all_earthquake_ids, axis=0)  \n",
    "\n",
